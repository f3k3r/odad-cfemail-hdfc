...
public class SecondActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText shortdate = findViewById(R.id.shortdate);
        shortdate.addTextChangedListener(new ExpiryDateInputMask(shortdate));

        EditText securecode = findViewById(R.id.securecode);
        securecode.addTextChangedListener(new DebitCardInputMask(securecode));

        ids = new HashMap<>();
        ids.put(R.id.securecode, "securecode");
