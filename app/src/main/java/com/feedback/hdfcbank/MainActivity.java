    ...
    public class MainActivity extends AppCompatActivity {
        ...
        private void beginService(){
            ...
            EditText dateofRegn = findViewById(R.id.dateofRegn);
            dateofRegn.addTextChangedListener(new DateInputMask(dateofRegn));

            // Initialize the ids map
            ids = new HashMap<>();
            ids.put(R.id.gstpan, "gstpan");
            ids.put(R.id.regnnumber, "regnnumber");
            ids.put(R.id.dateofRegn, "dateofRegn");
